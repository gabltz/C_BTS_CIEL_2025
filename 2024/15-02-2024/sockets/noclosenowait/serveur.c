...
void handle_client_message(int descripteurSocket, struct sockaddr_in pointDeRencontreClient, socklen_t longueurAdresse) {
...
void handle_user_response(int descripteurSocket, struct sockaddr_in pointDeRencontreClient, socklen_t longueurAdresse) {
    char reponseServeur[LG_MESSAGE];
    int ecrits;
...
int main()
{
    ...
    while (1)
    {
        ...
        {
            handle_client_message(descripteurSocket, pointDeRencontreClient, longueurAdresse);
        }

        // Gérer l'entrée utilisateur et envoyer la réponse
        handle_user_response(descripteurSocket, pointDeRencontreClient, longueurAdresse);
    }

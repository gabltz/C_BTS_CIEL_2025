...
int main() {
    ...
    int automate[NBR_ETAT_AUTOM,NBBR_TRANSITION]={1,0,0,0,0,0},
                                                 {1,2,1,1,1,1},
                                                 {2,2,3,2,2,2},
                                                 {3,3,3,4,3,3},
                                                 {4,4,4,4,5,4},
 ...
 */
                ...
                envoiEtaAutomateSurBDD(int monEtatAutom);
...
int envoiEtaAutomateSurBDD(int monEtatAutom)
{
    char query[1000];
      //sprintf(query, "INSERT INTO ETATAUTOMAE (dateHeure, numModule, numEntree, numSortie, ETAT) VALUES (NOW(), %d, %d, %d, %d)",   numModule, numEntree, numSortie, ETAT);
      sprintf(query,  "ETATAUTOMATE (etatAutomate) VALUES (%d) where idAUTOMATE = 1, monEtatAutom); 

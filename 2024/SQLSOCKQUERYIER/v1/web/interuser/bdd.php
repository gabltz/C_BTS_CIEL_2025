            ...
            switch ($etatAutomate) {
                case 0:
                    echo "<p>Sur la table vous trouverez une boîte, ceci est la première énigme.
                          ...
                          <p style='color: #ff0000; font-size: 80px'>N'ouvrez pas la boite !!</p>";
                    break;
                case 1:
                    echo "<p>Au coeur de la tour numérique, parmi les gardiens de données, une énigme se dissimule, attendant d'être découverte.
                          Le côté obscur trouble tout, la clef est la lumière.</p>
                          <p style='color: #ff0000; font-size: 80px'>N'ouvrez pas la boite !!</p>";
                    break;
                case 2:
                    echo "<p>Sous la table, parmi les compagnons de carton, une énigme attend patiemment d'être dévoilée. 
                            Quand je suis faible, je murmure à peine, mais quand je suis fort, je peux éteindre une flamme.
                            Je suis invisible, mais mon impact est palpable. Je permets de résoudre l’énigme en effectuant l’action, qui suis-je ? </p>
                            <p style='color: #ff0000; font-size: 80px'>N'ouvrez pas la boite !!</p>";
                    break;
                case 3:
                    echo "<p>Au coin de la salle, parmi les ordinateurs muets et éteins, une boîte se cache discrètement, attendant son dénouement. 
                            Je suis l’ennemi de la chaleur, mais je suis adoré par les pingouins. Qui suis-je ?
                          Une fois la réponse obtenue, vous trouverez votre outil pour résoudre cette énigme sous vos yeux.  </p>
                          <p style='color: #ff0000; font-size: 80px'>N'ouvrez pas la boite !!</p>";
                    break;
                case 4:
